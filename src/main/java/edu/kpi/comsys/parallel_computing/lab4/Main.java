package edu.kpi.comsys.parallel_computing.lab4;

import edu.kpi.comsys.parallel_computing.lab4.callable.CallableA;
import edu.kpi.comsys.parallel_computing.lab4.callable.CallableC;
import edu.kpi.comsys.parallel_computing.lab4.callable.CallableMA;
import edu.kpi.comsys.parallel_computing.lab4.callable.CallableMF;
import edu.kpi.comsys.parallel_computing.lab4.data.Matrix;
import edu.kpi.comsys.parallel_computing.lab4.data.Vector;
import edu.kpi.comsys.parallel_computing.lab4.util.FileUtil;
...
//        fileUtil.generateFile();
        ...
        for (int i = 0; i < p - 1; i++) {
            ...
            service.submit(new CallableMF(i, operations, barrier, lock));
        }
        ...
        futureMF = service.submit(new CallableMF(p - 1, operations, barrier, lock));
